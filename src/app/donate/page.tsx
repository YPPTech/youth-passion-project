...
const impactPoints = [
  {
    ...
    description: "Every dollar helps us offer 110+ courses at no cost to students.",
    icon: (
  ...
  },
  {
    ...
    description: "Fund training and resources for high schoolers who teach what they love.",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
  ...
  {
    title: "Expand reach",
    description: "Bring free learning to more communities and countries.",
    icon: (
      <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
        ...
        <div className="relative mx-auto max-w-5xl">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="font-body mx-auto mt-4 max-w-2xl text-lg text-[var(--ypp-muted)]">
              These partners help make our mission possible. We couldn’t do it without them.
            </p>
          </div>
