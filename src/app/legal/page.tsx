            ...
            {LEGAL_LINKS.map(({ href, label, internal }) => (
              <li key={label}>
                {internal ? (
                  <Link
                    href={href}
                    className="card-ypp flex items-center gap-2 px-5 py-4 font-body text-[var(--ypp-ink)] transition-colors hover:border-[var(--ypp-primary)] hover:bg-[var(--ypp-blush)] hover:text-[var(--ypp-primary)]"
                  >
