...
export const metadata: Metadata = {
  title: "Instructor Retainment Agreement | Youth Passion Project",
  description:
    "Instructor retainment agreement and related volunteer agreements for Youth Passion Project instructors.",
};
...
const sections: Section[] = [
  {
    ...
    title: "Notice",
    paragraphs: [
      "Please note that the signing of the following agreement does not constitute retainment by the Youth Passion Project Inc. of an individual as a volunteer or in any other role. For each individual who applies to teach a course as an instructor with the Youth Passion Project, said individual must agree to the Instructor Retainment Agreement and an authorized representative of the Youth Passion Project must also agree to the Instructor Retainment Agreement on behalf of the Youth Passion Project Inc. Pursuant to the By-Laws of the Youth Passion Project Inc. no volunteer is retained until and unless their name is listed on a public memorandum issued by an officer of the Youth Passion Project.",
    ],
  },
  {
    id: "instructor-retainment",
    title: "Instructor Retainment Agreement",
    paragraphs: [
      "1. The purpose of this instructor retainment agreement (hereafter \"Agreement\") is to set forth mutual understanding and agreement between the Youth Passion Project Inc. (hereafter \"The Project\"), a Delaware Nonprofit Corporation exempt by the Internal Revenue Service under 26 US Code Section 501(c)(3), and a volunteer (hereafter \"Volunteer\") on the retention of Volunteer by The Project and the terms of Volunteer's service.",
      "2. Volunteer shall be retained by The Project for the period of time starting when The Project and Volunteer have agreed to this agreement and ending sixty (60) days after the signing of this agreement as only a volunteer and shall have a title stipulated by The Project's Corporate Secretary. Volunteer agrees to the Volunteer Compensation Agreement (found herein below).",
...
export default function InstructorRetainmentPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl min-w-0">
          ...
          <div className="text-center">
            ...
            <h1 className="font-heading text-4xl font-bold tracking-tight text-[var(--ypp-ink)] sm:text-5xl">
              Instructor Retainment Agreement
            </h1>
            <p className="mt-4 text-lg text-[var(--ypp-muted)]">
              Terms and related agreements for YPP instructors.
            </p>
          </div>
        </div>
      </section>
