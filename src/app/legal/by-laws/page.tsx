...
const sections: Section[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "4. All volunteers of the Project who shall hold an instructional volunteer title shall be given the band of 4.",
      "a. Senior instructional volunteers shall hold the band of 4A.",
      "b. Instructional volunteers shall hold the band of 4B.",
